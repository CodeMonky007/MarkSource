...
@WebServlet(name = "Del_localSourceServlet")
public class Del_localSourceServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int i = operationSource.del_localSource(source_id);
        JSONObject json = new JSONObject();
        if(i==1){
            json.put( "code" ,200);
            json.put("msg","本地资源删除成功！");
