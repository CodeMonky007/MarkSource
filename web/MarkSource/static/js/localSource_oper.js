    ...
    table.on('tool(source-list)', function (obj) {
        ...
        if (layEvent == 'update') {
            layer.open({
                ...
                shadeClose: true,
                content: `
     <input type="hidden" value="` + data.source_id + `" class="source_id">
        <div class="layui-form-item" style="margin-top: 35px;">
        <label class="layui-form-label">资源类型</label>
        <div class="layui-input-inline">
    <input style="width: 250px;" type="text" name="source_type" required lay-verify="required"
...
<button style="margin:5px 0 0 20%;" class="layui-btn" lay-submit onclick="update_localSource();">修改提交</button>
</div>
</div>`
            })
                    ...
                    success: function (data) {
                        ...
                        if (code == 200) {
                            layer.msg(data.msg, {
                                ...
                                obj.del();
                                window.location.href = "manage_localSource.jsp";
                            });
                        } else {
                            layer.msg(data.msg, {
                                icon: 2,
